...
const RemoveFavorites = () => {
    return (
        <>
            <span className='mr-3'>Remove from favorites</span>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-file-x-fill" viewBox="0 0 16 16">
